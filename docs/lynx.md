...
Lynx have the sharpest eyesight of any cat. In medieval European folklore, the lynx was said to see through walls and into the earth. The phrase *lynx-eyed* entered scientific culture through the [Accademia dei Lincei](https://en.wikipedia.org/wiki/Accademia_dei_Lincei) ("Academy of the Lynx-Eyed"), founded in Rome in 1603 — one of the world's first scientific societies, whose members included Galileo. Their motto: *see sharply, verify deeply*.
...
- **Status:** [IUCN Near Threatened](https://www.iucnredlist.org/species/pdf/A177350310)
...
- **Status:** [IUCN Vulnerable](https://iucn.org/press-release/202406/iberian-lynx-rebounding-thanks-conservation-action-iucn-red-list) (upgraded from Endangered)
...
The [LIFE LynxConnect](https://www.lifelynxconnect.eu/) program, which coordinates cross-border conservation, concludes in 2026.
...
*Data sourced from [IUCN Red List](https://www.iucnredlist.org/), [Rewilding Europe](https://rewildingeurope.com/rewilding-in-action/wildlife-comeback/lynx/), [WWF](https://wwf.panda.org/discover/our_focus/wildlife_practice/profiles/mammals/eurasian_lynx/), [ISEC Canada](https://wildcatconservation.org/wild-cats/north-america/canada-lynx/), and [Britannica](https://www.britannica.com/animal/lynx-mammal).*
